...
public class RandomTankMovementInputHandler implements GameInputHandler {
    ...
    public RandomTankMovementInputHandler(Movable tank, OccupiedCells occupiedCells, GameMap gameMap) {
        this.tank = tank;
    ...
    public void handleInput() {
        ...
        for (Direction direction : directions) {
            MoveCommand command = new MoveCommand(tank, direction, occupiedCells, gameMap);
            if (command.execute()) {
                break;
            }
        }
